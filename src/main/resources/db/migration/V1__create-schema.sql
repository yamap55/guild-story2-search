...
CREATE TABLE m_item(id INT PRIMARY KEY, name VARCHAR(50), type_name VARCHAR(50), type_info VARCHAR(50), drop_location VARCHAR(255), price INT DEFAULT 0,attack INT DEFAULT 0,dexterity INT DEFAULT 0,defense INT DEFAULT 0,evasion INT DEFAULT 0,magic_attack INT DEFAULT 0,magic_defense INT DEFAULT 0,critical DOUBLE DEFAULT 0,attack_count DOUBLE DEFAULT 0,max_hp INT DEFAULT 0,trap_release INT DEFAULT 0,magic_recovery INT DEFAULT 0,pronunciation VARCHAR(50));
