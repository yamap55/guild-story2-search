CREATE TABLE m_super_rare(id INT PRIMARY KEY AUTO_INCREMENT, name VARCHAR(50), ability VARCHAR(500), pronunciation VARCHAR(50));
CREATE TABLE m_item(id INT PRIMARY KEY AUTO_INCREMENT, name VARCHAR(50), pronunciation VARCHAR(50));
